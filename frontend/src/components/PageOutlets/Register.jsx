    ...
    return (
        <div className="w-full  h-full flex justify-center bg-custom-gray p-10">
            <div className="mt-10 w-[50%] h-full bg-black/40 flex flex-col items-center p-4">
                    ...
                    <div className='font-bold text-2xl text-white'>Sign up For Barta News Account </div>
                    <div className='font-semibold text-white'>Already have an Account? <Link to='/user/login'>Sign In</Link></div>
